...
"""
Вычисление рядов (rows) и столбцов (cols) таблицы
"""
...
"""
Создание пустого изображения под будущую таблицу с формами.
...
def create_empty(n_shapes):
    ...
    fig_empty = np.empty((fig_base_height, fig_base_width, 3),
                         dtype=np.uint8)
